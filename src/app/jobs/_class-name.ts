...
export const ClassID = {
  ...
  [ClassIDEnum.Cardinal]: 'Cardinal',
  [ClassIDEnum.Windhawk]: 'Windhawk',
  [ClassIDEnum.ImperialGuard]: 'Imperial Guard',
  [ClassIDEnum.Biolo]: 'Biolo',
  [ClassIDEnum.AbyssChaser]: 'Abyss Chase',
  [ClassIDEnum.ElementalMaster]: 'Elemental Master',
  [ClassIDEnum.Inquisitor]: 'Inquisitor',
  [ClassIDEnum.Troubadour]: 'Troubadour',
  [ClassIDEnum.Trouvere]: 'Trouvere',
